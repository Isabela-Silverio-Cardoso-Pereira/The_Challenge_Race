    ...
    >
            <header className="headerBg">
                <div className="background">
                    ...
                    <Link style={linkStyle} to="/createQuestion"><div className="boxRace 1"><Link style={linkStyle} to="/createQuestion">Pergunta 1</Link> <Link style={linkStyle} to="/createQuestion"><svg className="arrowIcon  A" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" /></svg></Link></div></Link>
                    <Link style={linkStyle} to="/createQuestion"><div className="boxRace 2"><Link style={linkStyle} to="/createQuestion">Pergunta 2</Link> <Link style={linkStyle} to="/createQuestion"><svg className="arrowIcon  B" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" /></svg></Link></div></Link>
                    <Link style={linkStyle} to="/createQuestion"><div className="boxRace 3"><Link style={linkStyle} to="/createQuestion">Pergunta 3</Link> <Link style={linkStyle} to="/createQuestion"><svg className="arrowIcon  C" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" /></svg></Link></div></Link>
                    <Link style={linkStyle} to="/createQuestion"><div className="boxRace 4"><Link style={linkStyle} to="/createQuestion">Pergunta 4</Link> <Link style={linkStyle} to="/createQuestion"><svg className="arrowIcon  D" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" /></svg></Link></div></Link>
                    <Link style={linkStyle} to="/createQuestion"><div className="boxRace 5"><Link style={linkStyle} to="/createQuestion">Pergunta 5</Link><Link style={linkStyle} to="/createQuestion"><svg className="arrowIcon  E" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" /></svg></Link></div></Link>
                    <Link style={linkStyle} to="/createQuestion"><div className="boxRace 6"><Link style={linkStyle} to="/createQuestion">Pergunta 6</Link> <Link style={linkStyle} to="/createQuestion"><svg className="arrowIcon  F" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" /></svg></Link></div></Link>
                    <Link style={linkStyle} to="/createQuestion"><div className="boxRace 7"><Link style={linkStyle} to="/createQuestion">Pergunta 7</Link> <Link style={linkStyle} to="/createQuestion"><svg className="arrowIcon  G" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" /></svg></Link></div></Link>
                    <Link style={linkStyle} to="/createQuestion"><div className="boxRace 8"><Link style={linkStyle} to="/createQuestion">Pergunta 8</Link> <Link style={linkStyle} to="/createQuestion"><svg className="arrowIcon  H" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" /></svg></Link></div></Link>
                    <Link style={linkStyle} to="/createQuestion"><div className="boxRace 9"><Link style={linkStyle} to="/createQuestion">Pergunta 9</Link> <Link style={linkStyle} to="/createQuestion"><svg className="arrowIcon  I" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" /></svg></Link></div></Link>
                    <Link style={linkStyle} to="/createQuestion"><div className="boxRace 10"><Link style={linkStyle} to="/createQuestion">Pergunta 10</Link> <Link style={linkStyle} to="/createQuestion"> <svg className="arrowIcon  J" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" /></svg></Link></div></Link>
                    </div>
                </div>
                <div className="add">
